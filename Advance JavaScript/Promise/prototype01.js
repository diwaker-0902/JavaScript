...
const diwaker = new createUser("diwaker", 19)
const  ritesh = new createUser("ritesh", 21)
...
If no explicit return value is specified from the constructor, javascript assumes this, the newly created object, to the intended return value.
